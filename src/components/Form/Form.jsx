...
import { ActionType, MessageContentTypes } from '../Message/MessageReducer';
import './Form.scss';
      ...
      <section className="form">
        ...
        <form className="form__app" action="https://echo.htmlacademy.ru" method="POST" onSubmit={this.onSubmitHandler}>
          <fieldset className="form__subsection form__subsection--credit-terms">
            ...
            <p className="form__item">
              <input className="form__value" name="app-credit-period" id="app-credit-period" value={`${period} ${pluralize(period, PERIOD_VARIANTS)}`} readOnly />
